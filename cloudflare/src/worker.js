...
<section id="chat" class="chat"><div class="messages" id="messages"></div><div class="tools"><button id="call" class="call">📞 Start call</button><button id="leave" class="danger">Leave</button></div><div class="composer"><input id="text" maxlength="2000" placeholder="Type a message..."><button id="send">Send</button></div></section>
</main><script>
...
$('send').onclick=send;$('text').onkeydown=e=>{if(e.key==='Enter')send()};$('call').onclick=makeCall;$('leave').onclick=()=>{hangup();if(ws)ws.close();location.reload()};
